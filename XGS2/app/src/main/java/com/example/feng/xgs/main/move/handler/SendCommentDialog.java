...
public class SendCommentDialog implements View.OnClickListener {
    ...
    private SendCommentDialog(Activity activity) {
        this.mActivity = activity;
        mDialog = new AlertDialog.Builder(activity).create();
    }

    public static SendCommentDialog create(Activity activity) {
