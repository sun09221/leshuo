 ...
 * 标签布局
 */
public class LabelLayout2 extends ViewGroup{
    ...
    //是否为标签添加点击事件
    private boolean isAddOnClick = false;
    ...
    public LabelLayout2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        mVerticalMargin = array.getDimension(R.styleable.label_vertical_margin, dp2px(10));
        mHorizontalMargin = array.getDimension(R.styleable.label_horizontal_margin, dp2px(8));
        mTextSize = array.getDimension(R.styleable.label_text_size, 12);
        mTextColor = array.getColor(R.styleable.label_text_color, ContextCompat.getColor(context, R.color.black));
        mBackGroundResource = array.getResourceId(R.styleable.label_background, R.drawable.draw_select);
        array.recycle();
    }
    ...
    private void addNormalTextView(){
        View view = LayoutInflater.from(mContext).inflate(R.layout.label_empty_data, null);
        addView(view);
//        TextView tv = new TextView(mContext);
//        tv.setText("这个人很懒, 什么也没有留下");
...
//        addView(tv);
    ...
    private void addTextView(String title, int position){
        TextView tv = new TextView(mContext);
        tv.setText(title);
        tv.setPadding(dp2px(10), dp2px(5), dp2px(10), dp2px(5));
        tv.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT,LayoutParams.WRAP_CONTENT));
        tv.setTextSize(mTextSize);
        tv.setGravity(Gravity.CENTER);
        tv.setTextColor(mTextColor);
        tv.setBackgroundResource(mBackGroundResource);
