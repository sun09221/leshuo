...
public class SexSelectionDialog implements View.OnClickListener {

    private AlertDialog mDialog;
    private IDialogStringListener mListener;

    private SexSelectionDialog(Activity activity) {
        mDialog = new AlertDialog.Builder(activity).create();
    }

    public static SexSelectionDialog create(Activity activity) {
        return new SexSelectionDialog(activity);
    }
    ...
    public void beginShow(IDialogStringListener listener) {
        ...
        if (window != null) {
            window.setContentView(R.layout.homepage_dialog_sex_select);
            ...
            window.findViewById(R.id.tv_dialog_sex_all).setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_dialog_sex_women:
                ...
                mDialog.cancel();
                break;
            case R.id.tv_dialog_sex_all:
                LogUtils.d("全部");
                if(mListener != null){
                    mListener.onSure(ContentKeys.SEX_ALL);
                }
                mDialog.cancel();
                break;
