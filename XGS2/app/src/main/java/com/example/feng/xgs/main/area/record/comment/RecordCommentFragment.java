...
public class RecordCommentFragment extends EmptyFragment{
    ...
    public static RecordCommentFragment create(int type, String modelId){
        Bundle args = new Bundle();
        args.putInt(ContentKeys.ACTIVITY_TYPE, type);
        args.putString(ContentKeys.ACTIVITY_ID_ONLY, modelId);
        RecordCommentFragment fragment = new RecordCommentFragment();
    ...
    public Object setLayout() {
        ...
        return R.layout.include_recycle_view_list;
    }
...
//        });
    ...
    private void sendComment(){
         content = send_content.getText().toString();
        try {
