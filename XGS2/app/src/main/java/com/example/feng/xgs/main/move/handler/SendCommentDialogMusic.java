...
public class SendCommentDialogMusic implements View.OnClickListener {
    ...
    private SendCommentDialogMusic(Activity activity) {
        this.mActivity = activity;
        mDialog = new AlertDialog.Builder(activity).create();
    }

    public static SendCommentDialogMusic create(Activity activity) {
        return new SendCommentDialogMusic(activity);
    }
    ...
    private void sendComment(){
        ...
        map.put(ParameterKeys.MUSIC_ID, mDynamicId);
        map.put(ParameterKeys.CONTENT, content);

        String raw = JSON.toJSONString(map);
        RestClient.builder()
                .url(UrlKeys.COMMENT_MUSIC)
                .raw(raw)
                .loader(mActivity)
                .toast()
