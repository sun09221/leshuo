...
public class NaturalChildAdapterFriend extends BaseMultipleEntityAdapter implements BGANinePhotoLayout.Delegate {
    ...
    public NaturalChildAdapterFriend(List<BaseEntity> data) {
        super(data);
        addItemType(ItemTypeKeys.NATURAL_ATTENTION, R.layout.item_natural_friend);
        addItemType(ItemTypeKeys.NATURAL_VIDEO, R.layout.item_natural_video_friend);
    }
    ...
    protected void convert(final BaseViewHolder holder, final BaseEntity entity) {
        ...
        if(itemType == ItemTypeKeys.NATURAL_ATTENTION || itemType == ItemTypeKeys.NATURAL_VIDEO){
            holder.addOnClickListener(R.id.tv_natural_item_give_a_reward_friend);
            holder.addOnClickListener(R.id.iv_natural_item_head_friend);
            holder.addOnClickListener(R.id.tv_natural_item_attention_friend);
            holder.addOnClickListener(R.id.tv_natural_item_leave_message_friend);
            holder.addOnClickListener(R.id.tv_natural_item_like_image_friend);
            ...
            holder.setText(R.id.tv_natural_item_name_friend, name)
                    .setText(R.id.tv_natural_item_content_friend, entity.getField(EntityKeys.INFO));
//                    .setText(R.id.tv_natural_item_circle, entity.getField(EntityKeys.CIRCLE));

            ImageView imageViewHead = holder.getView(R.id.iv_natural_item_head_friend);
            ...
            final TextView tvLike = holder.getView(R.id.tv_natural_item_like_friend);
            final ImageView mgeLike = holder.getView(R.id.tv_natural_item_like_image_friend);
            TextView tvAttention = holder.getView(R.id.tv_natural_item_attention_friend);
...
//            });
            ...
            if(itemType == ItemTypeKeys.NATURAL_VIDEO){
                SampleCoverVideo gsyVideoPlayer = holder.getView(R.id.video_natural_item_friend);
...
//                        intent.putExtra(ContentKeys.ACTIVITY_PEOPLE_ID, entity.getField(EntityKeys.PEOPLE_ID));
                ...
                if(imgList != null){
                    BGANinePhotoLayout ninePhotoLayout = holder.getView(R.id.photo_natural_item_look_friend);
