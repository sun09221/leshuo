...
public class NaturalChildAdapter extends BaseMultipleEntityAdapter implements BGANinePhotoLayout.Delegate {
    ...
    public NaturalChildAdapter(List<BaseEntity> data) {
        super(data);
        addItemType(ItemTypeKeys.NATURAL_ATTENTION, R.layout.item_natural);
        addItemType(ItemTypeKeys.NATURAL_VIDEO, R.layout.item_natural_video);
    }
