package com.example.feng.xgs.chatui.widget;
...
import com.example.feng.xgs.chatui.util.AudioRecoderUtils;
import com.example.feng.xgs.chatui.util.PopupWindowFactory;
...
public class EmotionInputDetector {
    ...
    private IImUIMenuTouchListener mMenuListener;
    ...
    public void setOnMenuTouchListener(IImUIMenuTouchListener listener){
    ...
    public EmotionInputDetector bindToEditText(EditText editText) {
        ...
        mEditText.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                LogUtils.d("editText OnTouchListener");
                if(mMenuListener != null){
                    mMenuListener.onMenuTouch();
                }
    ...
    public EmotionInputDetector bindToSendButton(View sendButton) {
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String textInfo = mEditText.getText().toString();
                messageInfo.setContent(textInfo);

                mEditText.setText("");
                @SuppressWarnings("unchecked") IGlobalCallback<String> callback = CallbackManager
                        .getInstance()
                        .getCallback(CallbackType.IM_TEXT_MESSAGE);
                if (callback != null) {
                    callback.executeCallback(textInfo);
                }
    ...
    public EmotionInputDetector build() {
        ...
        View view = View.inflate(mActivity, R.layout.layout_chat_microphone, null);
    ...
    private void callBack(String path,long time){
        @SuppressWarnings("unchecked") IGlobalCallback<String> callback = CallbackManager
                .getInstance()
                .getCallback(CallbackType.IM_VOICE_MESSAGE);
        if (callback != null) {
            callback.executeCallback1(path,time);
        }
    }
