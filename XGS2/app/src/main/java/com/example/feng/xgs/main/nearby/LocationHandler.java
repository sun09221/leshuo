...
public class LocationHandler {
     ...
     * 初始化定位
     */
    public void initLocation(ILocationResultListener listener){
...
//                        double longitude = location.getLongitude();
                    ...
                    //定位失败
                    sb.append("错误码:")
                            .append(location.getErrorCode())
                            .append(location.getErrorInfo());
                    String result = sb.toString();
                    LogUtils.d("onLocationChanged: "+result);
//                    ToastUtils.showText(getContext(), "定位失败");
                }
                //解析定位结果，
            } else {
                ToastUtils.showText(mActivity, "定位失败");
            }
        }
    };
